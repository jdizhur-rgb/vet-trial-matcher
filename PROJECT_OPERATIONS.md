...
- All `/uk-europe/` pages are excluded from the production search index and sitemap; North America is the active SEO scope. Existing European URLs remain available temporarily so shared links do not become abrupt 404s.
