...
<div class="story-photo story-photo-right story-photo-senya"><img src="/assets/senya-about.jpg" alt="Senya, a Miniature Schnauzer" width="165" height="220"><span>Senya</span></div>
<p class="story-intro">I lost my soulmate dog, Senya, a Miniature Schnauzer, to cancer. It started with a small lump. We went to the vet, who felt it and said it was a lipoma and there was nothing to worry about. So I didn’t worry, for a while.</p>
...
<div class="story-photo story-photo-left story-photo-yasha"><img src="/assets/yasha-about.jpg" alt="Yasha" width="180" height="203"><span>Yasha</span></div>
...
<div class="founder-signoff"><img src="/assets/yuliia-senya-about.jpg" alt="Yuliia Dizhur with Senya" width="220" height="220"><div><strong>Yuliia Dizhur</strong><span>Founder, Vet Trial Finder</span></div></div>
</article>
'''
    d = root / 'about'
