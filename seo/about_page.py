...
<section class="story-break"><div class="story-scene yasha"><figure class="story-photo yasha"><img src="/assets/yasha-about.jpg?v=about-v4" alt="Yasha"><figcaption>Yasha</figcaption></figure><div class="story-copy"><p>A year later, during an exam, a small lump was found under the leg of our other dog, Yasha. I immediately asked for an aspiration. The test showed sarcoma. We were lucky to get in with an oncologist quickly because we were already patients at the hospital. A board-certified surgeon performed the surgery beautifully. Pathology showed histiocytic sarcoma, a very aggressive form of cancer.</p><p>Yasha is undergoing treatment now. I don’t know what is ahead of us, but this time I want to be prepared. I searched through the internet looking for information. I learned about the standard treatment protocols and prognosis and read several papers about experimental treatments, looking for something that might give him better chances.</p></div></div></section>
