...
.story-photo{float:left;width:26%;max-width:225px;box-sizing:border-box;margin:0 24px 14px 0;background:#f7fafc;border:1px solid #dce5ec;border-radius:16px;overflow:hidden;box-shadow:0 5px 18px rgba(23,36,59,.055)}
.story-scene.yasha .story-photo{float:right;margin:0 0 16px 28px}
.story-photo img{display:block;width:100%;height:auto;object-fit:contain;object-position:center center}
...
<section class="story-intro"><div class="story-scene senya-scene"><figure class="story-photo senya"><img src="/assets/senya-about.jpg?v=about-v5" alt="Senya, a Miniature Schnauzer"><figcaption>Senya</figcaption></figure><div class="story-copy"><p>I lost my soulmate dog, Senya, a Miniature Schnauzer, to cancer. It started with a small lump. We went to the vet, who felt it and said it was a lipoma and there was nothing to worry about. So I didn’t worry, for a while.</p><p>The lump grew quickly. We went to another vet. They did a fine needle aspiration and said the result was inconclusive, but if we wanted, they could remove it. We scheduled surgery. After the surgery, the surgeon came out and said that “it was something else.” Pathology showed a soft tissue sarcoma.</p><p>The first surgery did not achieve the wide margins generally recommended for a soft tissue sarcoma. The margins were dirty, meaning that some cancer cells had been left behind.</p><p>We tried to get an appointment with an oncologist. The earliest available appointment was four months away. Cancer doesn’t wait, so we flew to Europe for a second surgery to remove the dirty margins. The surgery was successful, the margins were clean, and the prognosis was excellent. We continued seeing an oncologist and had full staging done every two months.</p><p>A year later, during one of those routine checks, they found a 6 cm tumor in his lung. The next day it ruptured. Senya crossed the rainbow bridge. I was completely unprepared for it. It seemed that we had done everything right, so why did this happen? I blame myself. I should not have simply believed that the lump was harmless. I should have had it checked right away. Things might have gone differently.</p></div></div></section>
<div class="story-divider"></div>
<section class="story-break"><div class="story-scene yasha"><figure class="story-photo yasha"><img src="/assets/yasha-about.jpg?v=about-v4" alt="Yasha"><figcaption>Yasha</figcaption></figure><div class="story-copy"><p>A year later, during an exam, a small lump was found in the armpit of our other dog, Yasha. I immediately asked for an aspiration. The test showed sarcoma. We were lucky to get in with an oncologist quickly because we were already patients at the hospital. A board-certified surgeon performed the surgery beautifully. Pathology showed histiocytic sarcoma, a very aggressive form of cancer.</p><p>Yasha is undergoing treatment now. I don’t know what is ahead of us, but this time I want to be prepared. I searched through the internet looking for information. I learned about the standard treatment protocols and prognosis and read several papers about experimental treatments, looking for something that might give him better chances.</p></div></div></section>
