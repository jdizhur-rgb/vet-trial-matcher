...
ABOUT_CSS = '''
.about-story{max-width:800px;margin:0 auto;font-size:17px;line-height:1.62}.about-story h1{font-size:36px;line-height:1.14;margin:26px 0 22px}.about-story p{margin:0 0 17px}.story-intro{font-size:18px;line-height:1.58}.story-photo{margin:3px 0 16px}.story-photo-senya{width:165px}.story-photo-yasha{width:180px}.story-photo-right{float:right;margin-left:26px}.story-photo-left{float:left;margin-right:26px}.story-photo img{display:block;width:auto;max-width:100%;height:auto;border-radius:14px;border:1px solid #d9e2ea}.story-photo span{display:block;text-align:center;color:#607086;font-size:14px;margin-top:5px}.story-close{clear:both;padding:17px 19px;background:#edf4f8;border-radius:12px;margin-top:24px!important}.founder-signoff{display:flex;align-items:center;gap:13px;margin-top:20px}.founder-signoff img{width:120px;height:120px;object-fit:cover;border-radius:12px;border:1px solid #d9e2ea}.founder-signoff strong,.founder-signoff span{display:block}.founder-signoff span{color:#607086;font-size:14px;margin-top:2px}@media(max-width:650px){.about-story{font-size:16px;line-height:1.55}.about-story h1{font-size:26px;line-height:1.1;margin:14px 0}.about-story p{margin-bottom:12px}.story-intro{font-size:16px}.story-photo,.story-photo-right,.story-photo-left{float:none;width:auto;max-width:180px;margin:8px auto 14px}.story-photo-senya{max-width:165px}.story-photo span{font-size:12.5px;margin-top:3px}.story-close{padding:13px 14px;margin-top:16px!important}.founder-signoff{gap:10px;margin-top:15px}.founder-signoff img{width:82px;height:82px}.founder-signoff span{font-size:13.5px}}
'''
