...
<h2>What changed over the last 20 years?</h2>
<p>Many of the ideas in today's trials are not new. Veterinary oncologists were already testing cancer vaccines, immune stimulation and tumor-targeted treatments in dogs in the 2000s. What has changed is the ability to define targets more precisely, measure immune responses, engineer immune cells and combine these approaches with modern radiation and tumor-ablation techniques.</p>
<p><strong>Cancer vaccines</strong> are a good example. DNA vaccination for canine melanoma was already in clinical trials more than 20 years ago and eventually led to ONCEPT, a licensed melanoma vaccine. The treatment proved feasible and generally well tolerated, but later studies produced mixed evidence about whether it actually extends survival. Vaccine research did not disappear; it moved toward new targets, personalized vaccines, bacterial vectors and mRNA.</p>
<p><strong>Targeted drugs</strong> produced one of the clearest practical changes. Masitinib was approved in 2008 and toceranib (Palladia) in 2009, bringing kinase inhibitors into routine canine oncology. Toceranib clearly has activity in mast cell tumors and has been tested widely in other cancers. Twenty years of experience have also shown the limit of the idea: a molecular target or early signal does not mean a drug will work broadly. For example, later evidence has not supported toceranib as an effective treatment for metastatic osteosarcoma.</p>
<p><strong>Immunotherapy for osteosarcoma</strong> has been studied for decades because conventional treatment reached a plateau: surgery plus platinum chemotherapy controls the primary tumor, but metastatic disease remains the main problem. Vaccines, immune stimulants and cell therapies have repeatedly produced interesting immune responses and occasional long survivors. So far, none has replaced surgery plus chemotherapy as the established backbone of treatment.</p>
<p>The main change in the last decade is therefore not that one experimental treatment has solved canine cancer. Researchers can now ask more specific questions: which tumor target matters, which dog is likely to respond, whether an immune response actually changes survival, and whether local treatments such as radiation or histotripsy can be combined with systemic immune treatment. Today's CAR-cell, PD-1, mRNA, histotripsy and FLASH trials are newer tools aimed at many of the same old problems: metastasis, treatment resistance and microscopic disease.</p>
