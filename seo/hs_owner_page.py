...
<div class="hs-path" aria-label="Typical next steps after a histiocytic sarcoma diagnosis"><div><strong>HS diagnosis</strong><span>Know what the pathology found</span></div><b aria-hidden="true">→</b><div><strong>Staging</strong><span>Localized or spread?</span></div><b aria-hidden="true">→</b><div><strong>Plan</strong><span>Local + systemic options</span></div></div>
...
<div><h3>Your dog is already in treatment</h3><p>You may still have trial options. Look specifically for studies that allow previous surgery, chemotherapy or radiation, and ask what options remain if the current treatment stops working.</p></div></div>
...
<ul class="hs-questions"><li>Is this localized HS or is there evidence that it has spread?</li><li>Is the staging we have enough, or is anything important still missing?</li><li>If surgery was done, are the margins adequate and does the site need more local treatment?</li><li>Do you recommend systemic treatment now, and what are the realistic options?</li><li>Could treatment we start now affect eligibility for a clinical trial later?</li></ul>
