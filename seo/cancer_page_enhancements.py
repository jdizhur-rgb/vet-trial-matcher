...
def _collapse_card(match):
 ...
 locations=''.join(LOCATION_RE.findall(body))
 body=LOCATION_RE.sub('',body)
...
def _enhance(text):
 ...
 text=CARD_RE.sub(_collapse_card,text)
