...
NEW_HOME = '<div class="site-brand"><a class="home-link" href="https://jdizhur-rgb.github.io/vet-trial-matcher/" aria-label="Back to Cancer Trial Finder home">← Cancer Trial Finder</a><span class="site-tagline">Find cancer treatment options and clinical trials for dogs and cats.</span></div>'
...
CURRENT_FREE_NOTE = '<p class="free-note"><strong>100% FREE — view all matching trials, details, contacts and official enrollment links.</strong><br>No registration. No hidden results. No paid report.</p>'
NEW_FREE_NOTE = '<p class="free-note"><strong>100% FREE — view all matching trials, details, contacts and official enrollment links.</strong><br>Free means free. No hidden results. No paid report.</p>'
EXTRA_CSS = '''
h1{font-size:clamp(2rem,5vw,2.65rem);line-height:1.12;margin:28px 0 18px}
header{margin-bottom:22px}
.site-brand{display:flex;flex-direction:column;align-items:flex-start;gap:3px}
.home-link{display:inline-block;font-weight:700;text-decoration:none;font-size:1rem}
.home-link:hover{text-decoration:underline}
.site-tagline{font-size:.9rem;line-height:1.35;opacity:.78}
@media(max-width:600px){
 body{padding:22px 20px;line-height:1.5}
 h1{font-size:2rem;line-height:1.14;margin:22px 0 16px}
 header{margin-bottom:18px}
 .site-tagline{font-size:.88rem}
...
for page in SITE.rglob("index.html"):
    ...
    text = text.replace(CURRENT_FREE_NOTE, NEW_FREE_NOTE)
