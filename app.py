...
.nav-title{font-size:1.55rem;line-height:1.08;font-weight:700;margin:.15rem 0 .15rem;color:#55483f}.nav-title .paw{color:#9a6a43;font-family:Arial,sans-serif}.nav-subtitle{font-size:.92rem;color:#6f6a66;margin:0 0 .55rem}
.nav-buttons{margin-top:.15rem}
.nav-buttons+div div[data-testid="stButton"] button{min-height:2.45rem!important;width:100%!important;font-size:.9rem!important;font-weight:700!important;border-radius:.8rem!important}
.nav-buttons+div div[data-testid="column"]:first-child div[data-testid="stButton"] button{background:#eee8ff!important;color:#3b237a!important;border:1px solid #ddd2ff!important}
.nav-buttons+div div[data-testid="column"]:last-child div[data-testid="stButton"] button{background:#e8f3ff!important;color:#155ca8!important;border:1px solid #cfe5fb!important}
