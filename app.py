...
div[data-testid="stSegmentedControl"]{margin:0 0 .65rem!important}div[data-testid="stSegmentedControl"]>div{width:100%!important;display:grid!important;grid-template-columns:1fr 1fr!important;gap:0!important;border:1px solid rgba(100,160,220,.24)!important;border-radius:1rem!important;overflow:hidden!important}div[data-testid="stSegmentedControl"] button{width:100%!important;min-height:2.55rem!important;border:0!important;border-radius:0!important;font-size:.9rem!important;font-weight:700!important}div[data-testid="stSegmentedControl"] button:first-child{background:#eee8ff!important;color:#3b237a!important}div[data-testid="stSegmentedControl"] button:last-child{background:#e8f3ff!important;color:#155ca8!important}
...
@media(max-width:900px){.stMainBlockContainer,div[data-testid="stMainBlockContainer"]{padding:4.1rem 1rem 2rem!important;max-width:none!important}div[data-testid="stSegmentedControl"] button{min-height:2.65rem!important;font-size:.84rem!important}}
</style>""",unsafe_allow_html=True)
nav_choice=st.segmented_control("Navigation",["🐾 Clinical Trials","🧬 Other Options"],selection_mode="single",label_visibility="collapsed",key="top_navigation")
if nav_choice:
