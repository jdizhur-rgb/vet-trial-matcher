...
st.markdown(
    ...
    div[data-testid="stMainBlockContainer"] { padding-top: 3.25rem !important; }
    div[data-testid="stHorizontalBlock"]:has(div[data-testid="stPageLink"]) {
        gap: 0 !important; padding: 0 !important; margin: 0 !important;
        border: 1px solid rgba(100,160,220,.32); border-radius: 1.15rem;
        overflow: hidden; background: rgba(35,48,65,.55);
    }
    ...
    div[data-testid="stPageLink"] a {
        min-height: 3.45rem; width: 100%; display: flex; align-items: center;
        justify-content: center; margin: 0 !important; padding: .55rem .25rem !important;
        border: 0 !important; border-radius: 0 !important; background: transparent; white-space: nowrap;
    }
    div[data-testid="stPageLink"] a:hover { background: rgba(70,130,210,.22); }
    div[data-testid="stPageLink"] p {
        font-size: 1.02rem !important; line-height: 1.1 !important; font-weight: 700 !important; white-space: nowrap !important;
    }
    ...
    @media (max-width: 480px) {
        .stMainBlockContainer,
        div[data-testid="stMainBlockContainer"] { padding-top: 4.1rem !important; }
