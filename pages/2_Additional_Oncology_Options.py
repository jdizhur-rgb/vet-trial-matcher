        ...
        for x in matches:
            with st.container(border=True):
                ...
                with st.expander("Access & sample"):
                    ...
                    contact=[]
                    if x.get("contact_email"): contact.append(f"Email: [{x['contact_email']}](mailto:{x['contact_email']})")
                    if x.get("contact_phone"): contact.append(f"Phone: [{x['contact_phone']}](tel:{x['contact_phone'].replace('-', '')})")
