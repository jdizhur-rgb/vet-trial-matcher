...
# Match the Clinical Trial Finder title size and spacing.
st.markdown("<div style='height:1.45rem'></div>", unsafe_allow_html=True)
st.markdown("<h2 style='font-size:2rem; line-height:1.2; margin:0 0 1rem 0;'>🧬 Other Options</h2>", unsafe_allow_html=True)
