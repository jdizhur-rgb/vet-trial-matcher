# Triggered 2026-09-06 after workflow installation.
import json
...
new = [
  {
    ...
    "country": "USA", "state": "Washington", "species": "Dog",
    ...
    "verified": "2026-09-06", "study_type": "treatment", "available_for_matching": True,
    "status_confidence": "confirmed_current", "owner_prescreen_required": True
  },
  {
    ...
    "country": "USA", "state": "Minnesota", "species": "Dog",
  ...
  },
  {
    ...
    "country": "USA", "state": "Indiana", "species": "Dog",
