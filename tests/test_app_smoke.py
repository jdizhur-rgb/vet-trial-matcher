...
class AppSmokeTests(unittest.TestCase):
    ...
    def test_safe_initial_state(self):
        ...
        self.assertTrue({
            "🐾︎ Clinical Trials", "🏥 Oncology Centers",
            "🧬 Advanced Treatments", "🧪 Expanded Access",
        ...
        self.assertIsNone(number_values["Age (years, optional)"])
        self.assertIsNone(number_values["Weight (lb, optional)"])
